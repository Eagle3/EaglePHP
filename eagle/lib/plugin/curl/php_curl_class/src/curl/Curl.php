...
use \lib\plugin\curl\php_curl_class\src\curl\ArrayUtil;
use \lib\plugin\curl\php_curl_class\src\curl\Decoder;
...
class Curl
{
    ...
    private $jsonDecoder = '\lib\plugin\curl\php_curl_class\src\curl\Decoder::decodeJson';
    private $jsonDecoderArgs = array();
    private $jsonPattern = '/^(?:application|text)\/(?:[a-z]+(?:[\.-][0-9a-z]+){0,}[\+\.]|x-)?json(?:-[a-z]+)?/i';
    private $xmlDecoder = '\lib\plugin\curl\php_curl_class\src\curl\Decoder::decodeXml';
    ...
    {
        $this->jsonDecoder = '\lib\plugin\curl\php_curl_class\src\curl\Decoder::decodeJson';
    ...
    {
        $this->xmlDecoder = '\lib\plugin\curl\php_curl_class\src\curl\Decoder::decodeXml';
    }
